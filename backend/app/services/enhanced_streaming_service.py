# Enhanced Streaming Service - Comprehensive streaming with proper resource management
"""
Enhanced camera streaming service with proper async patterns, cleanup, and error handling.
This service can work alongside the existing frame distribution architecture.
"""
...
class EnhancedStreamingService:
    ...
    async def start(self):
        ...
        logger.info("Starting enhanced streaming service")
        # Start periodic cleanup task
        self._cleanup_task = asyncio.create_task(self._periodic_cleanup())
        
    async def stop(self):
        """Gracefully stop the streaming service"""
        logger.info("Stopping enhanced streaming service")
...
async def get_enhanced_streaming_service() -> EnhancedStreamingService:

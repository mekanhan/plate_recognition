class Sidebar {
    ...
    handleMenuClick(e) {
        e.preventDefault();
        const menuLink = e.currentTarget.querySelector('.menu-link');
        const pageId = menuLink ? menuLink.dataset.page : null;
    ...
    navigateToPage(pageId) {
        ...
        window.dispatchEvent(new CustomEvent('pageChange', {
            detail: {
                pageId,
                previousPage: this.activeMenuItem
            }
        }));
    }

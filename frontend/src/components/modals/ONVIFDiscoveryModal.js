/**
 * ONVIF Discovery Modal Component
 * Discovers and adds ONVIF cameras to the system
 */
...
class ONVIFDiscoveryModal {
                        ...
                        <div class="discovery-options">
                            ...
                            <div class="option-group">
                                ...
                                <div class="credentials-row" style="display: flex; gap: 8px;">
                                    <input type="text" 
                                           id="onvif-username-bulk" 
                                           class="form-input" 
                                           placeholder="Username"
                                           style="flex: 1;">
                                    <input type="password" 
                                           id="onvif-password-bulk" 
                                           class="form-input" 
            ...
            const cameraHTML = `
                <div class="camera-item" data-camera-index="${index}">
                    <input type="checkbox" 
                           ...
                           id="camera-${index}"
                           data-camera-ip="${camera.ip_address}">
                    ...
                    <div class="camera-info">
                        ...
                        <div class="camera-details">
                            ...
                            Brand: ${camera.detected_brand || 'Generic'}
                        </div>
                    </div>
    ...
    async addSelectedCameras() {
        ...
        // Refresh cameras page if any were added successfully
